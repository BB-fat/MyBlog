...
<img src="2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/IMG0431-8d6498b5.PNG" alt="IMG0431.PNG" style="zoom:33%;" />
...
![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-7c3163d0.png)

* 这里我找到了一张发票，首先输入发票号码
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-823d5385.png)
...
* 接下来我们继续输入发票号码
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-4cdd8698.png)
  有趣的事情出现了，发票号码失焦之后下面突然出现了验证码，这里我们得出结论：**验证码请求的时机是在发票号码失焦之后**
* 继续输入开票日期和校验码后六位
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-600aea49.png)
  **此时查验按钮还不可点击**
* 输入验证码
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-63c77f94.png)
  此时我们了解到税务总局的验证码含有中文和英文，并且**需要根据颜色指示输入**，让我们多刷新几次验证码。
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-5b0b9422.png)
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-71297745.png)
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-a8d6769f.png)
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-32d9afc6.png)
...
* 我将网页刷新然后F12打开Chrome的调试工具，点击Network然后将列表清空。
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-f15e2e57.png)
* 接下来我们重复刚才查验发票的操作，直到失焦发票号码输入框，然后观察验证码是怎么来的。
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-e892db31.png)
  此时我们发现了验证码的请求，看一下详细信息。
  ![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-e7ec9a9c.png)
...
![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-cee55a58.png)
...
![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-b6eec17a.png)
...
![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-76cbfecc.png)
可以看到它的值的确是定值false。
...
![image.png](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/image-4584fc3b.png)
...
![image-20200402162741225](2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/00831rSTly1gdfia93zkbj30uy0ke41c.jpg)

我使用Safari关闭了断点功能。

<img src="2019-08-31-逆向工程Python爬虫——国税局发票查验平台.assets/00831rSTly1gdfia3b75hj30gy05u0sy.jpg" alt="image-20200402162808849" style="zoom: 33%;" />
